    ...
    <>
      <main className="flex justify-between pl-[91px] pr-[80px] items-center flex-row h-screen w-full bg-backgroundColor">
        <div className="w-2/4">
          ...
          <h3 className="w-full bg-gradient-to-t from-gradient-200 to-gradient-100 bg-clip-text mt-4 text-transparent text-[42px] leading-[63px] font-bold">Front-End Developer</h3>
