  ...
  return (
    <>
      <section id="language" className="w-full bg-backgroundColor pb-[113px]">
        <div className="flex justify-center space-x-[24px] lg:pt-[60px] lg:pl-[330px] lg:pr-[285px] text-white pr-6 pl-6 pt-10">
        ...
        <div className="flex flex-row w-full lg:justify-center lg:space-x-[49px] pt-[115px] justify-evenly flex-wrap pr-2 pl-2 lg:pl-0 lg:pr-0">
          <div className="relative mb-20 lg:mb-0 h-[198px] bg-card">
            <div className="w-[190px] px-[15%] pt-[78px] ">
              ...
              <p className="text-[16px] font-semibold leading-6 text-white">TypeScript</p>
            </div>
          ...
          <div className="relative mb-20 lg:mb-0 h-[198px] bg-card">
            <div className="w-[190px] px-[15%] pt-[78px]">
              <h1 className="bg-gradient-to-r from-gradient-300 to-gradient-400 bg-clip-text text-center text-[32px] font-semibold leading-[48px] text-transparent">10+</h1>
              <p className="text-[16px] font-semibold leading-6 text-white">React JS</p>
            </div>
